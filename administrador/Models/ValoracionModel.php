<?php
class ValoracionModel extends MysqlAcademico
{
    private $db_name;
    ...
    public function consultarValoracion(){
        $sql = "SELECT val_id Ids,val_nombre Nombre,val_tipo_valoracion Tipo ";
        $sql .= "FROM ". $this->db_name .".valoracion where val_estado_logico!=0; ";
        $request = $this->select_all($sql);
        return $request;
    }
