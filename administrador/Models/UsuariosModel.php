...
public function consultarReporteUsuarioPDF(string $idUsuario, $idpersona = NULL){
		...
		public function consultarDatosId(int $Ids){
			$db_name=$this->getDbNameMysql();
			$idsEmpresa=1;
			$sql = "SELECT a.usu_id Ids,a.per_id,c.eusu_id,a.usu_correo,a.usu_alias Alias,b.per_cedula Dni,b.per_nombre Nombre,b.per_apellido Apellido,b.per_fecha_nacimiento FechaNac, ";
		...
		public function updateData(int $UsuId,string $Dni,string $FecNaci, string $Nombre, string $Apellido, string $Telefono, string $Correo,
									string $Clave,string $Genero,string $Direccion,string $Alias, int $rol_id, int $estado,int $per_id, int $eusu_id){
