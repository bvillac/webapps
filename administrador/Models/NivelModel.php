<?php
class NivelModel extends MysqlAcademico
{
    private $db_name;
    ...
    public function consultarNivel(){
        $sql = "SELECT niv_id Ids,niv_codigo Codigo,niv_nombre Nombre, niv_unidad_inicio UnidadInicio,niv_unidad_fin UnidadFin, ";
        $sql .= "       niv_total_unidad UnidadTotal,niv_examen1 Examen1,niv_examen2 Examen2 ";
        $sql .= " FROM ". $this->db_name .".nivel where niv_estado_logico!=0  ";
        $request = $this->select_all($sql);
        return $request;
    }
