			...
			<div class="row">
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						<i class="fa fa-street-view"></i> <?= DIRECCION ?> <br>
						<i class="fa fa-phone"></i> Tel: <a class="linkFooter" href="tel:<?= TELEMPRESA ?>"><?= TELEMPRESA ?></a><br>
						<i class="fa fa-envelope"></i> Email: <a class="linkFooter" href="mailto:<?= EMAIL_EMPRESA ?>"><?= EMAIL_EMPRESA ?></a>
					</p>
		...
		<!-- 		<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<a href="<?= FACEBOOK ?>" target="_blanck" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
						...
						<a href="<?= WHATSAPP ?>" target="_blanck"  class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
							<i class="fa fa-whatsapp"></i>
						</a>

						<a href="<?= TELEGRAM ?>" target="_blanck"  class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
...
<!-- Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> -->
						<?= TITULO_EMPRESA; ?> <script>document.write(new Date().getFullYear());</script> | <a href="https://colorlib.com" target="_blank">Colorlib</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
