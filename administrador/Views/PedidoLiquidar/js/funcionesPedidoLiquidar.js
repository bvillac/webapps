...
document.addEventListener('DOMContentLoaded', function () {
    tableTienda = $('#tableTienda').dataTable({
        ...
        "ajax": {
            "url": " " + base_url + "/PedidoLiquidar/consultarPedidos",
            "dataSrc": ""
        },
        "columns": [
            { "data": "numero" },
...
$(document).ready(function () {
    ...
    $("#btn_nuevopedido").click(function () {
        //eliminarStores();
        window.location = base_url + '/PedidoLiquidar/nuevo';//Retorna al Portal Principal
    });
    ...
    $("#btn_retornar").click(function () {
        ...
        window.location = base_url + '/PedidoLiquidar';//Retorna al Portal Principal
    });
...
function obtenerInfoTienda() {
    ...
    let url = base_url + '/PedidoLiquidar/retornarDatosTienda';
    var metodo = 'POST';
...
function guardarPedido() {
    ...
    let url = base_url + '/PedidoLiquidar/ingresarPedidoTemp';
    var metodo = 'POST';
    var dataPost = {
        accion: accion,
        cabIds: CabIds,
...
function fntAnularPedido(ids) {
    swal({
        ...
        if (isConfirm) {
            let url = base_url + '/PedidoLiquidar/anularPedidoTemp';
            var metodo = 'POST';
            var dataPost = {
                ids: ids
            };
...
function fntFacturarPedido(ids) {
    swal({
        title: "Facturar Pedido",
        text: "¿Realmente quiere Facturar el Registro?",
        type: "warning",
        showCancelButton: true,
        ...
        if (isConfirm) {
            let url = base_url + '/PedidoLiquidar/facturarPedido';
            var metodo = 'POST';
            var dataPost = {
                ids: ids
            };
            peticionAjaxSSL(url, metodo, dataPost, function (data) {
                // Manejar el éxito de la solicitud aquí
                if (data.status) {
                    swal("Facturado!", data.msg, "success");
                        tableTienda.api().ajax.reload(function () {
