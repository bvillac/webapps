	...
	<table class="tbl-cliente">
		<tbody>
			<tr>
				...
				<td class="wd40"><?= $cliente['Cedula'] ?></td>
				<td class="wd10">Tienda</td>
				<td class="wd40"><?= $tienda['NombreTienda'] ?></td>
			</tr>
			<tr>
				<td>Nombre:</td>
	...
	<table class="tbl-detalle">
		...
		<tfoot>
			...
			<tr>
				...
				<td class="text-right"><?= SMONEY.' '.formatMoney($subtotal,2); ?></td>
			</tr>
			
		</tfoot>
	</table>
	<div class="text-center">
		<p>Si tienes preguntas sobre tu pedido, <br> pongase en contacto con nombre, teléfono y Email a <?= $empresa['Correo'] ?></p>
