...
function realizarSolicitudAJAX(type,url, callback) {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4) {
            ...
            if (xhr.status === 200) {
                ...
                // Continuar con otros procesos después de recibir la respuesta
                console.log("Continuar con otros procesos...");
            } else {
