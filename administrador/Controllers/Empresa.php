...
class Empresa extends Controllers
{
	...
	public function getEmpresas()
	{
		if ($_SESSION['permisosMod']['r']) {
			...
			for ($i = 0; $i < count($arrData); $i++) {
				...
				if ($_SESSION['permisosMod']['r']) {
					$btnOpciones .= '<button class="btn btn-primary btn-sm btnDelEmpresa" onClick="fntModuloEmpresa(' . $arrData[$i]['Ids'] . ')" title="Modulo Empresa Datos"><i class="fa fa-trash"></i></button>';
				}
	...
	public function getEmpresaModulos()
	{
		if ($_POST) {
